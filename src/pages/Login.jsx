      ...
      <div className="login-box pt-5 mt-2">
        ...
        <div className="login-inner-box rounded-4 p-4 py-5 mx-3 p-sm-5">
          ...
          <form onSubmit={formik.handleSubmit}>
            <div className="mb-4">
              <div className={`email - login rounded-pill d-flex justify-content-between ${formik.touched.email && formik.errors.email ? "error-border" : ""}`}>
                <input
            ...
            <div>
              <div className={`password-login rounded-pill  d-flex justify-content-between ${formik.touched.password && formik.errors.password ? "error-border" : ""}`}>
                <input
                  name="password"
                  className="border-0 py-2 ps-3  w-100 bg-transparent"
